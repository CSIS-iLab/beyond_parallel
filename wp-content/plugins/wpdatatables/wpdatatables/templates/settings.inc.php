				...
				<div id="normal-sortables" class="meta-box-sortables ui-sortable">
					<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all settings">
						<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all settings">
							<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active settings"><a href="#tabs-1" class="ui-tabs-anchor settings"><div class="dashicons dashicons-admin-tools"></div> Main settings</a></li>
							<li class="ui-state-default ui-corner-top settings"><a href="#tabs-2" class="ui-tabs-anchor settings"><div class="dashicons dashicons-art"></div> Color and font settings</a></li>
							<li class="ui-state-default ui-corner-top settings"><a href="#tabs-3" class="ui-tabs-anchor settings"><div class="dashicons dashicons-exerpt-view"></div> Custom JS and CSS</a></li>
						</ul>
					    ...
					    <div class="inside">
							...
							<tbody>
							<?php //[<-- Full version insertion #19 -->]// ?>
							    <tr valign="top">
								<th scope="row">
								    <label for="wpUseSeparateCon"><?php _e('Use separate MySQL connection','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="checkbox" <?php //[<-- Full version insertion #08 -->]// ?> id="wpUseSeparateCon" name="wpUseSeparateCon" <?php if ($wpUseSeparateCon) { ?>checked="checked"<?php } ?> />
					    ...
					    <div class="inside">
							...
							<tbody>
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtTableFontColor"><?php _e('Table font color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtTableFontColor" id="wdtTableFontColor" value="<?php echo (!empty($wdtFontColorSettings['wdtTableFontColor']) ? $wdtFontColorSettings['wdtTableFontColor'] : '') ?>" />
								    <span class="description"><?php _e('This color is used for the main font in table cells','wpdatatables'); ?>.</span>
								</td>
							    </tr>
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtHeaderBaseColor"><?php _e('Header background color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtHeaderBaseColor" id="wdtHeaderBaseColor" value="<?php echo (!empty($wdtFontColorSettings['wdtHeaderBaseColor']) ? $wdtFontColorSettings['wdtHeaderBaseColor'] : '') ?>" />
								    <span class="description"><?php _e('The color is used for background of the table header','wpdatatables'); ?>.</span>
								</td>
							    </tr>
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtHeaderBorderColor"><?php _e('Header border color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtHeaderBorderColor" id="wdtHeaderBorderColor" value="<?php echo (!empty($wdtFontColorSettings['wdtHeaderBorderColor']) ? $wdtFontColorSettings['wdtHeaderBorderColor'] : '') ?>" />
								    <span class="description"><?php _e('This color is used for the border in the table header','wpdatatables'); ?>.</span>
								</td>
							    </tr>     
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtHeaderFontColor"><?php _e('Header font color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtHeaderFontColor" id="wdtHeaderFontColor" value="<?php echo (!empty($wdtFontColorSettings['wdtHeaderFontColor']) ? $wdtFontColorSettings['wdtHeaderFontColor'] : '') ?>" />
								    <span class="description"><?php _e('This color is used for the font in the table header','wpdatatables'); ?>.</span>
								</td>
							    </tr>
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtHeaderHoverColor"><?php _e('Header active and hover color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtHeaderActiveColor" id="wdtHeaderActiveColor" value="<?php echo (!empty($wdtFontColorSettings['wdtHeaderActiveColor']) ? $wdtFontColorSettings['wdtHeaderActiveColor'] : '') ?>" />
							    ...
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtTableOuterBorderColor"><?php _e('Table outer border color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtTableOuterBorderColor" id="wdtTableOuterBorderColor" value="<?php echo (!empty($wdtFontColorSettings['wdtTableOuterBorderColor']) ? $wdtFontColorSettings['wdtTableOuterBorderColor'] : '') ?>"  />
								    <span class="description"><?php _e('This color is used for the outer border of the whole table body','wpdatatables'); ?>.</span>
								</td>
							    </tr>           
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtEvenRowColor"><?php _e('Even row background color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtEvenRowColor" id="wdtEvenRowColor" value="<?php echo (!empty($wdtFontColorSettings['wdtEvenRowColor']) ? $wdtFontColorSettings['wdtEvenRowColor'] : '') ?>" />
								    <span class="description"><?php _e('This color is used for for background in even rows','wpdatatables'); ?>.</span>
								</td>
							    </tr>           
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtOddRowColor"><?php _e('Odd row background color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtOddRowColor" id="wdtOddRowColor" value="<?php echo (!empty($wdtFontColorSettings['wdtOddRowColor']) ? $wdtFontColorSettings['wdtOddRowColor'] : '') ?>" />
								    <span class="description"><?php _e('This color is used for for background in odd rows','wpdatatables'); ?>.</span>
								</td>
							    </tr>           
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtHoverRowColor"><?php _e('Hover row color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtHoverRowColor" id="wdtHoverRowColor" value="<?php echo (!empty($wdtFontColorSettings['wdtHoverRowColor']) ? $wdtFontColorSettings['wdtHoverRowColor'] : '') ?>" />
							    ...
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtActiveEvenCellColor"><?php _e('Cell color in active (sorted) columns for even rows','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtActiveEvenCellColor" id="wdtActiveEvenCellColor" value="<?php echo (!empty($wdtFontColorSettings['wdtActiveEvenCellColor']) ? $wdtFontColorSettings['wdtActiveEvenCellColor'] : '') ?>" />
							    ...
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtActiveOddCellColor"><?php _e('Cell color in active (sorted) columns for odd rows','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtActiveOddCellColor" id="wdtActiveOddCellColor" value="<?php echo (!empty($wdtFontColorSettings['wdtActiveOddCellColor']) ? $wdtFontColorSettings['wdtActiveOddCellColor'] : '') ?>" />
							    ...
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtSelectedRowColor"><?php _e('Backround color for selected rows','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtSelectedRowColor" id="wdtSelectedRowColor" value="<?php echo (!empty($wdtFontColorSettings['wdtSelectedRowColor']) ? $wdtFontColorSettings['wdtSelectedRowColor'] : '') ?>" />
								    <span class="description"><?php _e('This color is used for background in selected rows','wpdatatables'); ?>.</span>
								</td>
							    </tr>         
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtButtonColor"><?php _e('Buttons background color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtButtonColor" id="wdtButtonColor" value="<?php echo (!empty($wdtFontColorSettings['wdtButtonColor']) ? $wdtFontColorSettings['wdtButtonColor'] : '') ?>" />
								    <span class="description"><?php _e('This color is used for background in buttons','wpdatatables'); ?>.</span>
								</td>
							    </tr>         
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtButtonBorderColor"><?php _e('Buttons border color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtButtonBorderColor" id="wdtButtonBorderColor" value="<?php echo (!empty($wdtFontColorSettings['wdtButtonBorderColor']) ? $wdtFontColorSettings['wdtButtonBorderColor'] : '') ?>" />
								    <span class="description"><?php _e('This color is used for border in buttons','wpdatatables'); ?>.</span>
								</td>
							    </tr>         
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtButtonColor"><?php _e('Buttons font color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtButtonFontColor" id="wdtButtonFontColor" value="<?php echo (!empty($wdtFontColorSettings['wdtButtonFontColor']) ? $wdtFontColorSettings['wdtButtonFontColor'] : '') ?>" />
								    <span class="description"><?php _e('This color is used for font in buttons','wpdatatables'); ?>.</span>
								</td>
							    </tr>         
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtButtonBackgroundHoverColor"><?php _e('Buttons background hover color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtButtonBackgroundHoverColor" id="wdtButtonBackgroundHoverColor" value="<?php echo (!empty($wdtFontColorSettings['wdtButtonBackgroundHoverColor']) ? $wdtFontColorSettings['wdtButtonBackgroundHoverColor'] : '') ?>" />
								    <span class="description"><?php _e('This color will be used for button backgrounds when you hover above them','wpdatatables'); ?>.</span>
								</td>
							    </tr>
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtButtonFontHoverColor"><?php _e('Buttons hover font color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtButtonFontHoverColor" id="wdtButtonFontHoverColor" value="<?php echo (!empty($wdtFontColorSettings['wdtButtonFontHoverColor']) ? $wdtFontColorSettings['wdtButtonFontHoverColor'] : '') ?>" />
								    <span class="description"><?php _e('This color will be used for buttons font when you hover above them','wpdatatables'); ?>.</span>
								</td>
							    </tr>
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtModalFontColor"><?php _e('Modals font color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtModalFontColor" id="wdtModalFontColor" value="<?php echo (!empty($wdtFontColorSettings['wdtModalFontColor']) ? $wdtFontColorSettings['wdtModalFontColor'] : '') ?>" />
								    <span class="description"><?php _e('This color will be used for wpDataTable popup (filter, datepicker) fonts','wpdatatables'); ?>.</span>
								</td>
							    </tr>
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtModalBackgroundColor"><?php _e('Modals background color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtModalBackgroundColor" id="wdtModalBackgroundColor" value="<?php echo (!empty($wdtFontColorSettings['wdtModalBackgroundColor']) ? $wdtFontColorSettings['wdtModalBackgroundColor'] : '') ?>" />
							    ...
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtOverlayColor"><?php _e('Overlay background color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtOverlayColor" id="wdtOverlayColor" value="<?php echo (!empty($wdtFontColorSettings['wdtOverlayColor']) ? $wdtFontColorSettings['wdtOverlayColor'] : '') ?>" />
							    ...
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtButtonBorderHoverColor"><?php _e('Buttons hover border color','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtButtonBorderHoverColor" id="wdtButtonBorderHoverColor" value="<?php echo (!empty($wdtFontColorSettings['wdtButtonBorderHoverColor']) ? $wdtFontColorSettings['wdtButtonBorderHoverColor'] : '') ?>" />
								    <span class="description"><?php _e('This color will be used for button borders when you hover above them','wpdatatables'); ?>.</span>
								</td>
							    </tr>
							    <tr valign="top">
								<th scope="row">
								    <label for="wdtBorderRadius"><?php _e('Buttons and inputs border radius (in px)','wpdatatables'); ?><?php //[<-- Full version insertion #18 -->]// ?></label>
								</th>
								<td>
								    <input type="text" <?php //[<-- Full version insertion #08 -->]// ?> name="wdtBorderRadius" id="wdtBorderRadius" value="<?php echo (!empty($wdtFontColorSettings['wdtBorderRadius']) ? $wdtFontColorSettings['wdtBorderRadius'] : '') ?>" />
