...
(function(Handsontable, $){
    ...
    Handsontable.editors.BaseEditor.prototype.cancelChanges = function() {
        ...
        if ( settings.wpDataTablesExcelPlugin ) {
            ...
            if( $editorElement.length > 0 && $editorElement.tooltip('instance') ) {
    ...
    function initWdtDateEditor() {
        var ExcelDateEditor = Handsontable.editors.DateEditor.prototype.extend();
        ...
        ExcelDateEditor.prototype.init = function() {
            ...
            this.same_display_and_edit_format = table_settings.dataSourceDateFormat == table_settings.displayDateFormat;
        };
        ...
        //this is a fix for bug that when invalid date is tried to be saved, date picker was unable to appear.
        ExcelDateEditor.prototype.discardEditor = function(validationResult) {
            Handsontable.editors.DateEditor.prototype.discardEditor.apply(this, arguments);
        ...
        ExcelDateEditor.prototype.close = function() {
            Handsontable.editors.DateEditor.prototype.close.apply(this, arguments);
        ...
        // Put editor in dedicated namespace
        Handsontable.editors.ExcelDateEditor = ExcelDateEditor;
    ...
    function initWdtAttachmentEditor() {
        ...
        ExcelAttachmentEditor.prototype.init = function() {
            ...
            $browseButton = $('<buttnon class="button-primary">' + wpdatatables_frontend_strings.browse_file + '</buttnon>');
