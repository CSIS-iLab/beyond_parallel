 		...
 		$column_index++;
 	 	...
 	 	if(get_option('wdtUseSeparateCon')){
            ...
            if( $this->_db->getLastError() != '' ){
                wpdatatables_delete_table( $wpdatatable_id );
        ...
        private function _buildMySQLQuery(){
         ...
         public function getQueryPreview(){
            ...
            if( !empty( $result ) ){
                ...
                $ret_val = __('No results found. Please check if this query is correct! Table Constructor needs a query that returns data to build a wpDataTable.','wpdatatables');
            }
            return $ret_val;
         }
