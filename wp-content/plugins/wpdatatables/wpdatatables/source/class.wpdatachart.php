...
class WPDataChart
{
    ...
    public static function factory($constructedChartData, $loadFromDB = true)
    {
        ...
        $chartObj->setBackgroundColor(WDTTools::defineDefaultValue($constructedChartData, 'background_color', '#4572A7'));
        ...
        $chartObj->setPlotBackgroundColor(WDTTools::defineDefaultValue($constructedChartData, 'plot_background_color', 'undefined'));
        $chartObj->setPlotBackgroundImage(WDTTools::defineDefaultValue($constructedChartData, 'plot_background_image', 'undefined'));
        ...
        $chartObj->setSubtitle(WDTTools::defineDefaultValue($constructedChartData, 'subtitle', 'undefined'));
        ...
        $chartObj->setTooltipValuePrefix(WDTTools::defineDefaultValue($constructedChartData, 'tooltip_value_prefix', 'undefined'));
        $chartObj->setTooltipValueSuffix(WDTTools::defineDefaultValue($constructedChartData, 'tooltip_value_suffix', 'undefined'));
